...
Here is the `completed register index <https://github.com/lucask07/covg_fpga/blob/daq_v2/examples/register_index_guide_completed_example.xlsx>`_ for this example. You can read the registers into pypanel using the :py:meth:`~pyripherals.core.Register.get_chip_registers` method.
